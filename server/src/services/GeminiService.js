...
// Implements text/summary streaming from the `gemini-2.5-flash` model,
// handles rate-limiting / server overload retries, and supports fallback to non-stream mode if parsing fails.
